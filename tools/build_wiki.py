...
SHOTS = {
    "## Locking a vehicle for the first time": ("lock-vehicle-menu.png", "Lock for BLUFOR, Lock for my squad, Lock to my key and Check lock"),
    "## Managing a vehicle": ("manage-keys-menu.png", "Manage keys: Opens for, Cut keys, Change locks, Name vehicle, Release vehicle"),
    "## Your own keys": ("own-keys-menu.png", "The player's Vehicle Keys menu: two programmed fobs in key slots, a master key and a blank vehicle key"),
    "## Key fobs": ("program-fob-menu.png", "Manage keys, Cut keys, Program Key Fob (blank)"),
    "## Key bindings and key slots": ("key-bindings-screen.png", "Controls, Configure Addons, TLB Keys: lock/unlock nearest vehicle and three key slots"),
    "## Lockpicking and hotwiring": ("lockpick-menu.png", "Vehicle Keys, Pick lock, With Lock Pick Kit on a locked vehicle"),
    "### Hotwiring from the driver's seat": ("hotwire-menu.png", "Vehicle Keys, Hotwire from the driver's seat"),
    "## Handing keys to other players": ("handover-menu.png", "Hand over key on another player, listing the keys carried"),
}
