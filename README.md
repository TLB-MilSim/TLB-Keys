...
The [full guide](docs/guide.md) walks through all of it with examples.

## Documentation

| Page | For |
| --- | --- |
| [Full guide](docs/guide.md) | Players: every feature, step by step, with examples and troubleshooting. |
| [Mission making](docs/mission-making.md) | Mission makers: Key Set and Master Key modules, vehicle attributes, Zeus modules, scripting. |
| [All settings](docs/settings.md) | Server admins: every CBA setting with its default and effect, and an example settings file. |
| [How it works](docs/how-it-works.md) | Developers: how keys store their cut, how access is decided, locality, how ACE is replaced. |
