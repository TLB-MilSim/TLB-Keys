...
| **Lockpicking** | A lock pick kit opens vehicles your keys do not fit: on [TLB Interactions](https://github.com/TLB-MilSim/TLB-Interactions)' board when that mod is loaded, otherwise with a progress bar. TLB Keys ships a kit for servers that have neither TLB Interactions nor TSP Breach, and hides it when they do. A picked vehicle is hotwired until someone locks it again. |
